...
# name
PRODUCT_RELEASE_NAME := VZWGS3

# device
$(call inherit-product-if-exists, device/samsung/d2vzw/full_d2vzw.mk)
...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.d2vzw.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="d2vzw-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/d2vzw:4.2.2/JDQ39/573038:user/release-keys"
